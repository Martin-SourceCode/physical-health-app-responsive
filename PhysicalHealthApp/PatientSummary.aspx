    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>&nbsp;New Test Results <asp:Button ID="btnCreateNewTest" runat="server" CssClass="btn btn-primary pull-right" Text="Create"</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
